---
layout: post
title: 이펙티브 타입스크립트 2장 ( 6 ~ 16 )
author: admin
date: 2023-01-08 18:00:00 +900
lastmod: 2023-01-11 19:36:00 +900
sitemap:
  changefreq: monthly
  priority: 0.5
categories: [이펙티브 타입스크립트, 2장]
tags: [이펙티브 타입스크립트, 서브 타입, 타입 단언, 잉여 속성 체크, 공통 속성 체크, type vs interface, indexing, keyof, 인덱스 시그니처]
image:
...
첫 번째로 `TypeScript`의 `Utility Types`인 [`Record`](/posts/TypeScript-UtilityTypes/#-record){:target="_blank"}를 사용하는 것입니다.<br />
