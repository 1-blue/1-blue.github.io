...
# 🧹 세팅
## 0️⃣ TypeScript 세팅 ( tsconfig.json )
...
## 2️⃣ Webpack 세팅 ( 공통 ) ( webpack.common.ts )
...
## 3️⃣ Webpack 세팅 ( 개발용 ) ( webpack.dev.ts )
```ts
// webpack.dev.ts
...
## 4️⃣ Webpack 세팅 ( 배포용 ) ( webpack.prod.ts )
```ts
// webpack.prod.ts
